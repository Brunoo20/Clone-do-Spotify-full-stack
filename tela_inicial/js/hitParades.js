$(document).ready(function () {
    ...
    function renderHitParades(data) {
        ...
        const title = $('<h2>').text('Paradas').addClass('section-title episodes-podcasts');
        ...
        const title2 = $('<h2>').text('Paradas').addClass('section-title episodes-podcasts2').hide();
        ...
        function renderHits(limit) {
            ...
            function renderBatch() {
                ...
                batch.forEach(parade => {
                    ...
                    const truncatedDescription = parade.description.length > 44
